...
import { navLinks, socialLinks, siteConfig } from '@/data/site';
                      ...
                      <div className="overflow-hidden">
                         ...
                         >
                            {socialLinks.map((link) => (
                              <Link key={link.title} href={link.href} className="hover:text-white transition-colors" aria-label={link.ariaLabel} target="_blank" rel="noopener noreferrer">{link.title}</Link>
                            ))}
                         </motion.div>
                     </div>
                 </div>
